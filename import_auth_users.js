...
async function main() {
  const users = [
    ...
    { email: 'firas@irl.sa', name: 'Firas Al Arifi', role: 'viewer', password_hash: '$2b$10$svPKNgUy.A06VZuhdGr4GeZUgQBb.XhjY.McRp3JNx0S8lm30rR9i', created_at: '2026-05-14 13:49:27.491+00' },
    { email: 'saad@irl.sa', name: 'Saad', role: 'viewer', password_hash: '$2b$10$hjyXqNeb3EaoNMn7J448R.CmVblVTBOs4q0pLDK3tUNM7MVkfWHIu', created_at: '2026-05-14 13:49:27.043+00' }
  ];
